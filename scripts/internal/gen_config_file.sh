...
GET_SOURCE_CONFIG()
{
    ...
    SOURCE_EXTRA_FIRMWARES=("SM-S911B/EUX/352404918452655")
...
GEN_CONFIG_FILE()
{
    ...
    {
        echo "# Automatically generated by legacyui/scripts/internal/gen_config_file.sh"
...
source "$SRC_DIR/legacyui/config.sh"
# ]
