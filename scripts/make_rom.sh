...
if $BUILD_ROM; then
    ...
    awk '$2 != "0"' out/work_dir/configs/file_context-system > out/work_dir/configs/file_context-system.clean
    mv out/work_dir/configs/file_context-system.clean out/work_dir/configs/file_context-system
