...
if $TARGET_AUDIO_SUPPORT_ACH_RINGTONE; then
    ...
    EVAL "sed -i 's/sput-boolean v2, Lcom\/samsung\/android\/secsoundpicker\/util\/PickerRune;->SUPPORT_SAMSUNG_BRAND_SOUND_ONEUI_7:Z/sput-boolean v3, Lcom\/samsung\/android\/secsoundpicker\/util\/PickerRune;->SUPPORT_SAMSUNG_BRAND_SOUND_ONEUI_7:Z/g' \"$APKTOOL_DIR/priv-app/SecSoundPicker/SecSoundPicker.apk/smali/com/samsung/android/secsoundpicker/util/PickerRune.smali\""
