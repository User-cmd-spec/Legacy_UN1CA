...
if $TARGET_AUDIO_SUPPORT_ACH_RINGTONE; then
    ADD_TO_WORK_DIR "$SOURCE" "system" \
        ...
        cd /home/runner/work/Legacy_UN1CA/Legacy_UN1CA/out/work_dir/system
        DECODE_APK "system/priv-app/SecSoundPicker/SecSoundPicker.apk"
    sed -i 's/sput-boolean v2, Lcom\/samsung\/android\/secsoundpicker\/util\/PickerRune;->SUPPORT_SAMSUNG_BRAND_SOUND_ONEUI_7:Z/sput-boolean v3, Lcom\/samsung\/android\/secsoundpicker\/util\/PickerRune;->SUPPORT_SAMSUNG_BRAND_SOUND_ONEUI_7:Z/g' "$APKTOOL_DIR/system/priv-app/SecSoundPicker/SecSoundPicker.apk/smali/com/samsung/android/secsoundpicker/util/PickerRune.smali"
    cd /home/runner/work/Legacy_UN1CA/Legacy_UN1CA/
...
# Removed Adaptive tone as im using a366b as source and not S901B
...
DOWNLOAD_FILE "$(GET_GALAXY_STORE_DOWNLOAD_URL "com.samsung.android.app.moments")" \
     "$SOURCE/system/priv-app/Moments/Moments.apk"
ADD_TO_WORK_DIR "$SOURCE" "system" \
